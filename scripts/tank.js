...
function main() {
  ...
  const makeCamera = (fov = 40) => new THREE.PerspectiveCamera(fov, window.innerWidth / window.innerHeight, 0.1, 1000)
  ...
  const domeGeometry = new THREE.SphereGeometry(2, 12, 12, 0, Math.PI * 2, 0, Math.PI * .5)
